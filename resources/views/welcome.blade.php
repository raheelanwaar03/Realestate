    ...
    <div class="body-inner">
        ...
        <div class="banner-carousel banner-carousel-1 mb-0">
            <div class="banner-carousel-item"
                style="background-image:url({{ asset('assets/images/slider-main/bg1.jpg') }})">
            ...
            <div class="banner-carousel-item"
                style="background-image:url({{ asset('assets/images/slider-main/bg3.jpg') }})">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 text-center">
                        <img loading="lazy" class="img-fluid"
                            src="{{ asset('assets/images/services/service-center.jpg') }}"
                    ...
                    <div class="col-12">
                        ...
                        <div class="row shuffle-wrapper">
                            ...
                            <div class="col-lg-4 col-md-6 shuffle-item"
                                ...
                                <div class="project-img-container">
                                    <a class="gallery-popup"
                                        href="{{ asset('assets/images/projects/project1.jpg') }}"
                                        aria-label="project-img">
                                        <img class="img-fluid"
                                            src="{{ asset('assets/images/projects/project1.jpg') }}"
                                            alt="project-img">
                            ...
                            <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;healthcare&quot;]">
                                <div class="project-img-container">
                                    <a class="gallery-popup"
                                        href="{{ asset('assets/images/projects/project2.jpg') }}"
                                        aria-label="project-img">
                                        <img class="img-fluid"
                                            src="{{ asset('assets/images/projects/project2.jpg') }}"
                                            alt="project-img">
                                        <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                    </a>
                                    <div class="project-item-info">
                            ...
                            <div class="col-lg-4 col-md-6 shuffle-item"
                                ...
                                <div class="project-img-container">
                                    <a class="gallery-popup"
                                        href="{{ asset('assets/images/projects/project3.jpg') }}"
                                        aria-label="project-img">
                                        <img class="img-fluid"
                                            src="{{ asset('assets/images/projects/project3.jpg') }}"
                                            alt="project-img">
                                        <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                    </a>
                                    <div class="project-item-info">
                            ...
                            <div class="col-lg-4 col-md-6 shuffle-item"
                                ...
                                <div class="project-img-container">
                                    <a class="gallery-popup"
                                        href="{{ asset('assets/images/projects/project4.jpg') }}"
                                        aria-label="project-img">
                                        <img class="img-fluid"
                                            src="{{ asset('assets/images/projects/project4.jpg') }}"
                                            alt="project-img">
                                        <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                    </a>
                                    <div class="project-item-info">
                            ...
                            <div class="col-lg-4 col-md-6 shuffle-item"
                                ...
                                <div class="project-img-container">
                                    <a class="gallery-popup"
                                        href="{{ asset('assets/images/projects/project5.jpg') }}"
                                        aria-label="project-img">
                                        <img class="img-fluid"
                                            src="{{ asset('assets/images/projects/project5.jpg') }}"
                                            alt="project-img">
                                        <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                    </a>
                                    <div class="project-item-info">
                            ...
                            <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;residential&quot;]">
                                <div class="project-img-container">
                                    <a class="gallery-popup"
                                        href="{{ asset('assets/images/projects/project6.jpg') }}"
                                        aria-label="project-img">
                                        <img class="img-fluid"
                                            src="{{ asset('assets/images/projects/project6.jpg') }}"
                                            alt="project-img">
                                        <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                                    </a>
                                    <div class="project-item-info">
                        ...
                        <div id="testimonial-slide" class="testimonial-slide">
                                ...
                                <div class="quote-item">
                                    ...
                                    <div class="quote-item-footer">
                                        <img loading="lazy" class="testimonial-thumb"
                                            src="{{ asset('assets/images/clients/testimonial1.png') }}"
                                            alt="testimonial">
                            ...
                            <div class="item">
                                <div class="quote-item">
                                    ...
                                    <div class="quote-item-footer">
                                        <img loading="lazy" class="testimonial-thumb"
                                            src="{{ asset('assets/images/clients/testimonial2.png') }}"
                                            alt="testimonial">
                                        <div class="quote-item-info">
                            ...
                            <div class="item">
                                <div class="quote-item">
                                    ...
                                    <div class="quote-item-footer">
                                        <img loading="lazy" class="testimonial-thumb"
                                            src="{{ asset('assets/images/clients/testimonial3.png') }}"
                                            alt="testimonial">
                                        <div class="quote-item-info">
                            ...
                            <div class="col-sm-4 col-6">
                                <figure class="clients-logo">
                                    <a href="#!"><img loading="lazy" class="img-fluid"
                                            src="{{ asset('assets/images/clients/client1.png') }}"
                                            alt="clients-logo" /></a>
                                </figure>
                            </div>
                            <div class="col-sm-4 col-6">
                                <figure class="clients-logo">
                                    <a href="#!"><img loading="lazy" class="img-fluid"
                                            src="{{ asset('assets/images/clients/client2.png') }}"
                                            alt="clients-logo" /></a>
                                </figure>
                            </div>
                            <div class="col-sm-4 col-6">
                                <figure class="clients-logo">
                                    <a href="#!"><img loading="lazy" class="img-fluid"
                                            src="{{ asset('assets/images/clients/client3.png') }}"
                                            alt="clients-logo" /></a>
                                </figure>
                            </div>
                            <div class="col-sm-4 col-6">
                                <figure class="clients-logo">
                                    <a href="#!"><img loading="lazy" class="img-fluid"
                                            src="{{ asset('assets/images/clients/client4.png') }}"
                                            alt="clients-logo" /></a>
                                </figure>
                            </div>
                            <div class="col-sm-4 col-6">
                                <figure class="clients-logo">
                                    <a href="#!"><img loading="lazy" class="img-fluid"
                                            src="{{ asset('assets/images/clients/client5.png') }}"
                                            alt="clients-logo" /></a>
                                </figure>
                            </div>
                            <div class="col-sm-4 col-6">
                                <figure class="clients-logo">
                                    <a href="#!"><img loading="lazy" class="img-fluid"
                                            src="{{ asset('assets/images/clients/client6.png') }}"
                                            alt="clients-logo" /></a>
                                </figure>
                            </div>
                        </div>
                        ...
                        <div class="latest-post">
                            <div class="latest-post-media">
                                <a href="news-single.html" class="latest-post-img">
                                    <img loading="lazy" class="img-fluid"
                                        src="{{ asset('assets/images/news/news1.jpg') }}" alt="img">
                                </a>
                            </div>
                            <div class="post-body">
                                <h4 class="post-title">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="latest-post">
                            <div class="latest-post-media">
                                <a href="news-single.html" class="latest-post-img">
                                    <img loading="lazy" class="img-fluid"
                                        src="{{ asset('assets/images/news/news2.jpg') }}" alt="img">
                                </a>
                            </div>
                            <div class="post-body">
                                <h4 class="post-title">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="latest-post">
                            <div class="latest-post-media">
                                <a href="news-single.html" class="latest-post-img">
                                    <img loading="lazy" class="img-fluid"
                                        src="{{ asset('assets/images/news/news3.jpg') }}" alt="img">
                                </a>
                            </div>
                            <div class="post-body">
                                <h4 class="post-title">
