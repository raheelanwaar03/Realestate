...
@section('content')
    <div class="banner-carousel banner-carousel-1 mb-0">
                ...
                <div class="container h-100">
                    <div class="row align-items-center h-100">
                        <div class="col-md-12 text-center">
                            <h2 class="slide-title" data-animation-in="slideInLeft">15 Years of excellence in</h2>
                            <h3 class="slide-sub-title" data-animation-in="slideInRight">Construction Industry
                            </h3>
                            <p data-animation-in="slideInLeft" data-duration-in="1.2">
                                <a href="services.html" class="slider btn btn-primary">Our Services</a>
                                <a href="{{ route('user.contactUs') }}" class="slider btn btn-primary border">Contact Now</a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="banner-carousel-item" style="background-image:url({{ asset('assets/images/banner/banner2.jpg') }})">
                    ...
                    <div class="row align-items-center h-100">
                        <div class="col-md-12">
                            ...
                            <div data-animation-in="slideInLeft">
                                <a href="{{ route('user.contactUs') }}" class="slider btn btn-primary"
                                    aria-label="contact-with-us">Contact</a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-center text-md-right mt-3 mt-md-0">
                        <div class="call-to-action-btn">
                            <a class="btn btn-dark" href="{{ route('user.contactUs') }}">Contact Us</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="ts-intro">
                        ...
                        <h3 class="into-sub-title">{{ env('APP_NAME') }}</h3>
                        <p>Ni kampuni ya masuala ya ujenzi iliyoanza kazi zake mnamo mwaka
                            2007 kama wazalishaji na wasambazaji wa vifaa vya ujenzi ndani ya mkoa wa Dar es salaam
                            na mikoa jirani.Kuanzia mwaka 2009 kampuni ilinza kujenga nyumba na kuuza maeneo mbali-
                            mbali ndani ya mkoa wa Dar es salaam ikiwemo Goba,Kigamboni,Malamba mawili,Mbezi na
                            Kibaha
                            kwa gharama nafuu sana, wateja wengi walikuwa wakivutiwa na nyumba tunazozi uza lakini
                            sababu za kijografia wateja walipendezewa kujengewa kwenye viwanja walivyonunua wao
                            ndipo
                            tukaanza fanya ujenzi kwa wateja wetu.
                            Hatukuishia hapo kwa kuwa lengo letu lilikuwa ni kuwafikia wateja wengi zaidi wenye nia
                            ya
                            kujengewa nyumba kwa gharama nafuu na stahiki mwaka 2015 ndipo KIFARU REAL ESTATE
                            ikaja na wazo la mradi pendwa wa “JENGEWA NYUMBA YA NDOTO YAKO na MALIPO BAADA YA
                            KUKABIDHIWA MJENGO WAKO”</p>
                    </div>
                ...
                <div class="col-lg-6 mt-4 mt-lg-0">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae pariatur porro ea magnam laudantium vel
                        sapiente molestiae temporibus non iure..</p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0 mb-4 mb-lg-0">
                    ...
                    <div class="ts-service-box d-flex">
                        <div class="ts-service-box-img">
                            <img loading="lazy" src="{{ asset('assets/images/icon-image/service-icon5.png') }}"
                                alt="service-icon">
                        </div>
                        <div class="ts-service-box-info">
            ...
            <div class="row">
                    ...
                    <div class="latest-post">
                        <div class="latest-post-media">
                            <a href="news-single.html" class="latest-post-img">
                                <img loading="lazy" class="img-fluid" src="{{ asset('assets/images/news/news1.jpg') }}"
                                    alt="img">
                            </a>
                        </div>
                        <div class="post-body">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="latest-post">
                        <div class="latest-post-media">
                            <a href="news-single.html" class="latest-post-img">
                                <img loading="lazy" class="img-fluid" src="{{ asset('assets/images/news/news2.jpg') }}"
                                    alt="img">
                            </a>
                        </div>
                        <div class="post-body">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="latest-post">
                        <div class="latest-post-media">
                            <a href="news-single.html" class="latest-post-img">
                                <img loading="lazy" class="img-fluid" src="{{ asset('assets/images/news/news3.jpg') }}"
                                    alt="img">
                            </a>
                        </div>
                        <div class="post-body">
